    ...
    extend: {
      ...
      colors: {
        dax: {
          ...
          blue:    '#39BEF9',
          violet:  '#1A9FD8',
          border:  'rgba(57, 190, 249, 0.12)',
          'border-light': '#D8DEE6',
          // light section text
          'light-primary':  '#061528',
          'light-secondary':'#2E3D50',
          'light-tertiary': '#6B7E92',
        },
      },
      backgroundImage: {
        'radial-glow-electric': 'radial-gradient(circle, rgba(57, 190, 249, 0.22) 0%, transparent 70%)',
        'radial-glow-blue':     'radial-gradient(circle, rgba(26, 159, 216, 0.15) 0%, transparent 70%)',
      },
      animation: {
